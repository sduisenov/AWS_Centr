...
{
	public partial class DAOTrail : DATACONN0_BaseData
	{
		...
		///This method returns one row from the table trail based on the primary key(s)
		///</Summary>
		///<returns>
		///DAOTrail
		///</returns>
		...
		///Int32? id
		///</parameters>
		public static DAOTrail SelectOne(Int32? id)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectOne;
			...
			try
			{
				...
				if(dt.Rows.Count > 0)
				{
					...
					retObj._trainid1					 = Convert.IsDBNull(dt.Rows[0]["trainid1"]) ? (Int32?)null : (Int32?)dt.Rows[0]["trainid1"];
					...
					retObj._trainid2					 = Convert.IsDBNull(dt.Rows[0]["trainid2"]) ? (Int32?)null : (Int32?)dt.Rows[0]["trainid2"];
				}
				return retObj;
			}
			catch
		...
		///this method allows the object to delete itself from the table trail based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteOne;
			command.CommandType = CommandType.Text;
		...
		///This method returns all data rows in the table trail based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOTrail.
		///</returns>
		...
		///Int32? senderid
		///</parameters>
		public static IList<DAOTrail> SelectAllBySenderid(Int32? senderid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllBySenderid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<DAOTrail> objList = new List<DAOTrail>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOTrail retObj = new DAOTrail();
						...
						retObj._trainid1					 = Convert.IsDBNull(row["trainid1"]) ? (Int32?)null : (Int32?)row["trainid1"];
						...
						retObj._trainid2					 = Convert.IsDBNull(row["trainid2"]) ? (Int32?)null : (Int32?)row["trainid2"];
						objList.Add(retObj);
					}
				}
				return objList;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllBySenderidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table trail with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteAllBySenderid;
			command.CommandType = CommandType.Text;
		...
		///Int32? productid
		///</parameters>
		public static IList<DAOTrail> SelectAllByProductid(Int32? productid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByProductid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByProductidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteAllByProductid;
			command.CommandType = CommandType.Text;
			command.Connection = connectionProvider.Connection;
			command.Transaction = connectionProvider.CurrentTransaction;
		...
		///Int32? operationid
		///</parameters>
		public static IList<DAOTrail> SelectAllByOperationid(Int32? operationid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByOperationid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByOperationidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteAllByOperationid;
			command.CommandType = CommandType.Text;
			command.Connection = connectionProvider.Connection;
			command.Transaction = connectionProvider.CurrentTransaction;
		...
		///Int32? returnid
		///</parameters>
		public static IList<DAOTrail> SelectAllByReturnid(Int32? returnid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByReturnid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByReturnidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteAllByReturnid;
			command.CommandType = CommandType.Text;
			command.Connection = connectionProvider.Connection;
			command.Transaction = connectionProvider.CurrentTransaction;
		...
		///Int32? userid
		///</parameters>
		public static IList<DAOTrail> SelectAllByUserid(Int32? userid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByUserid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByUseridCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteAllByUserid;
			command.CommandType = CommandType.Text;
			command.Connection = connectionProvider.Connection;
			command.Transaction = connectionProvider.CurrentTransaction;
		...
		///Int32? lineid
		///</parameters>
		public static IList<DAOTrail> SelectAllByLineid(Int32? lineid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByLineid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllByLineidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_DeleteAllByLineid;
			command.CommandType = CommandType.Text;
			command.Connection = connectionProvider.Connection;
			command.Transaction = connectionProvider.CurrentTransaction;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table trail
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
			...
			try
			{
				...
				command.Parameters.Add(new SqlParameter("@trainid1", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_trainid1?? (object)DBNull.Value));
				...
				command.Parameters.Add(new SqlParameter("@trainid2", SqlDbType.Int, 4, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, (object)_trainid2?? (object)DBNull.Value));
				...
				_trainid1					 = Convert.IsDBNull(command.Parameters["@trainid1"].Value) ? (Int32?)null : (Int32?)command.Parameters["@trainid1"].Value;
				...
				_trainid2					 = Convert.IsDBNull(command.Parameters["@trainid2"].Value) ? (Int32?)null : (Int32?)command.Parameters["@trainid2"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table trail
		///</Summary>
		///<returns>
		///IList-DAOTrail.
		///</returns>
		...
		///
		///</parameters>
		public static IList<DAOTrail> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAll;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///DAOTrail daoTrail
		///</parameters>
		public static IList<DAOTrail> SelectAllBySearchFields(DAOTrail daoTrail)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllBySearchFields;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				command.Parameters.Add(new SqlParameter("@id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Id?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@number", SqlDbType.VarChar, 12, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.Number?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@doctara", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.Doctara?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@docbrutto", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.Docbrutto?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@docnetto", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.Docnetto?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@weightcount", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Weightcount?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w1time", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.W1time?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w1result", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W1result?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w1tara", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W1tara?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w1brutto", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W1brutto?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w1netto", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W1netto?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w1scale", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.W1scale?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w2time", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.W2time?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w2result", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W2result?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w2tara", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W2tara?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w2brutto", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W2brutto?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w2netto", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.W2netto?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@w2scale", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.W2scale?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@session", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Session?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@receiverid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Receiverid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@senderid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Senderid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@productid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Productid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@operationid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Operationid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@lotnumber", SqlDbType.VarChar, 255, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.Lotnumber?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@trainid1", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Trainid1?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@minesid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Minesid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@zagrnumber", SqlDbType.VarChar, 13, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.Zagrnumber?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@returnid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Returnid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@userid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Userid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@sessionid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Sessionid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@speed", SqlDbType.Float, 8, ParameterDirection.Input, true, 53, 0, "", DataRowVersion.Proposed, (object)daoTrail.Speed?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@nplatf", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Nplatf?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@lineid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Lineid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@tvagonid", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Tvagonid?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@vid1", SqlDbType.VarBinary, 2147483647, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.Vid1?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@vid2", SqlDbType.VarBinary, 2147483647, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.Vid2?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@vid3", SqlDbType.VarBinary, 2147483647, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)daoTrail.Vid3?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@pr1", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Pr1?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@pr2", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Pr2?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@pr3", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Pr3?? (object)DBNull.Value));
				command.Parameters.Add(new SqlParameter("@trainid2", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)daoTrail.Trainid2?? (object)DBNull.Value));
		...
		///DAOTrail daoTrail
		///</parameters>
		public static Int32 SelectAllBySearchFieldsCount(DAOTrail daoTrail)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_SelectAllBySearchFieldsCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table trail based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprtrail_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
...
namespace Awsd5.DataObjects
{
	...
	{
		internal static string ctprtrail_SelectOne = @"
		...
		internal static string ctprtrail_DeleteOne = @"
		...
		internal static string ctprtrail_SelectAllBySenderid = @"
		...
		internal static string ctprtrail_SelectAllBySenderidCount = @"
		...
		internal static string ctprtrail_DeleteAllBySenderid = @"
		...
		internal static string ctprtrail_SelectAllByProductid = @"
			-- Select all rows based on a foreign key
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprtrail_SelectAllByProductidCount = @"
			-- Get count of rows returnable by this query
			-- selects count of all rows from the table
			SELECT COUNT(*)
			FROM [dbo].[trail]
		...
		internal static string ctprtrail_DeleteAllByProductid = @"
		...
		internal static string ctprtrail_SelectAllByOperationid = @"
			-- Select all rows based on a foreign key
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprtrail_SelectAllByOperationidCount = @"
			-- Get count of rows returnable by this query
			-- selects count of all rows from the table
			SELECT COUNT(*)
			FROM [dbo].[trail]
		...
		internal static string ctprtrail_DeleteAllByOperationid = @"
		...
		internal static string ctprtrail_SelectAllByReturnid = @"
			-- Select all rows based on a foreign key
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprtrail_SelectAllByReturnidCount = @"
			-- Get count of rows returnable by this query
			-- selects count of all rows from the table
			SELECT COUNT(*)
			FROM [dbo].[trail]
		...
		internal static string ctprtrail_DeleteAllByReturnid = @"
		...
		internal static string ctprtrail_SelectAllByUserid = @"
			-- Select all rows based on a foreign key
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprtrail_SelectAllByUseridCount = @"
			-- Get count of rows returnable by this query
			-- selects count of all rows from the table
			SELECT COUNT(*)
			FROM [dbo].[trail]
		...
		internal static string ctprtrail_DeleteAllByUserid = @"
		...
		internal static string ctprtrail_SelectAllByLineid = @"
			-- Select all rows based on a foreign key
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprtrail_SelectAllByLineidCount = @"
			-- Get count of rows returnable by this query
			-- selects count of all rows from the table
			SELECT COUNT(*)
			FROM [dbo].[trail]
		...
		internal static string ctprtrail_DeleteAllByLineid = @"
		...
		internal static string ctprtrail_InsertOne = @"
			-- Insert a new row
		...
		internal static string ctprtrail_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprtrail_SelectAllCount = @"
		...
		internal static string ctprtrail_SelectAllBySearchFields = @"
			...
			AND ([trainid1] LIKE @trainid1 OR @trainid1 is null)
			...
			AND ([trainid2] LIKE @trainid2 OR @trainid2 is null)
			";

		internal static string ctprtrail_SelectAllBySearchFieldsCount = @"
			-- Get count of rows returnable by this query
		...
		internal static string ctprtrail_UpdateOne = @"
