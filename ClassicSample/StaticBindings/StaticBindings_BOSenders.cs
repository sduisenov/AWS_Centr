...
namespace Awsd5.ClassicSample.StaticBindings
{
	...
	{
		public void UpdateSendersList()
		{	OnPropertyChanged("SendersList");	}

		public static IList<BOSenders> SendersList
		{
			get
			{
				try
				{
					IList<BOSenders> listSenders = BOSenders.SendersCollection();
					return listSenders;
				}
				catch(Exception)
