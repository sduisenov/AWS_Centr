...
namespace Awsd5.ClassicSample.StaticBindings
{
	...
	{
		public void UpdateLogtablesList()
		{	OnPropertyChanged("LogtablesList");	}

		public static IList<BOLogtables> LogtablesList
		{
			get
			{
				try
				{
					IList<BOLogtables> listLogtables = BOLogtables.LogtablesCollection();
					return listLogtables;
				}
				catch(Exception)
