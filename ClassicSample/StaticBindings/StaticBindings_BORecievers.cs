...
namespace Awsd5.ClassicSample.StaticBindings
{
	...
	{
		public void UpdateRecieversList()
		{	OnPropertyChanged("RecieversList");	}

		public static IList<BORecievers> RecieversList
		{
			get
			{
				try
				{
					IList<BORecievers> listRecievers = BORecievers.RecieversCollection();
