...
namespace Awsd5.ClassicSample.StaticBindings
{
	...
	{
		public void UpdateProducttypesList()
		{	OnPropertyChanged("ProducttypesList");	}

		public static IList<BOProducttypes> ProducttypesList
		{
			get
			{
				try
				{
					IList<BOProducttypes> listProducttypes = BOProducttypes.ProducttypesCollection();
