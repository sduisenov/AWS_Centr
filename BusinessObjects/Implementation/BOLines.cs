...
namespace Awsd5.BusinessObjects
{
	///<Summary>
	///Class definition
	///This is the definition of the class BOLines.
	///It maintains a collection of BOContainers,BOTrail objects.
	///</Summary>
	public partial class BOLines : DATACONN0_BaseBusiness
	{
		...
		///Int32 id
		///</parameters>
		public BOLines(Int32 id)
		{
			try
			{
				DAOLines daoLines = DAOLines.SelectOne(id);
				_id = daoLines.Id;
				_name = daoLines.Name;
				_number = daoLines.Number;
			}
			catch
			{
				throw;
		...
		///DAOLines
		///</parameters>
		protected internal BOLines(DAOLines daoLines)
		{
			try
			{
				_id = daoLines.Id;
		...
		///<Summary>
		///SaveNew
		///This method persists a new Lines record to the store
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			DAOLines daoLines = new DAOLines();
			RegisterDataObject(daoLines);
			BeginTransaction("savenewBOLines");
			try
			{
				daoLines.Name = _name;
				daoLines.Number = _number;
				daoLines.Insert();
				CommitTransaction();
			...
			{
				RollbackTransaction("savenewBOLines");
				throw;
			}
		}
		...
		///<Summary>
		///Update
		///This method updates one Lines record in the store
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Update()
		{
			DAOLines daoLines = new DAOLines();
			RegisterDataObject(daoLines);
			BeginTransaction("updateBOLines");
			try
			{
				daoLines.Id = _id;
				daoLines.Name = _name;
			...
			{
				RollbackTransaction("updateBOLines");
				throw;
			}
		}
		///<Summary>
		///Delete
		///This method deletes one Lines record from the store
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Delete()
		{
			DAOLines daoLines = new DAOLines();
			RegisterDataObject(daoLines);
			BeginTransaction("deleteBOLines");
			try
			{
				daoLines.Id = _id;
				daoLines.Delete();
			...
			{
				RollbackTransaction("deleteBOLines");
				throw;
			}
		}
		...
		///<Summary>
		///LinesCollection
		///This method returns the collection of BOLines objects
		///</Summary>
		///<returns>
		///List[BOLines]
		///</returns>
		...
		///
		///</parameters>
		public static IList<BOLines> LinesCollection()
		{
			try
			{
				IList<BOLines> boLinesCollection = new List<BOLines>();
				IList<DAOLines> daoLinesCollection = DAOLines.SelectAll();
			
				foreach(DAOLines daoLines in daoLinesCollection)
					boLinesCollection.Add(new BOLines(daoLines));
			
				return boLinesCollection;
			}
			catch
			{
				throw;
		...
		///<Summary>
		///LinesCollectionCount
		///This method returns the collection count of BOLines objects
		///</Summary>
		///<returns>
		///Int32
		///</returns>
		...
		///
		///</parameters>
		public static Int32 LinesCollectionCount()
		{
			try
			{
				Int32 objCount = DAOLines.SelectAllCount();
				return objCount;
			}
			catch
			{
		...
		///<Summary>
		///LinesCollectionFromSearchFields
		///This method returns the collection of BOLines objects, filtered by a search object
		///</Summary>
		///<returns>
		///List<BOLines>
		///</returns>
		...
		///
		///</parameters>
		public static IList<BOLines> LinesCollectionFromSearchFields(BOLines boLines)
		{
			try
			{
				IList<BOLines> boLinesCollection = new List<BOLines>();
				DAOLines daoLines = new DAOLines();
				daoLines.Id = boLines.Id;
				daoLines.Name = boLines.Name;
				daoLines.Number = boLines.Number;
				IList<DAOLines> daoLinesCollection = DAOLines.SelectAllBySearchFields(daoLines);
			
				foreach(DAOLines resdaoLines in daoLinesCollection)
					boLinesCollection.Add(new BOLines(resdaoLines));
		...
		///<Summary>
		///LinesCollectionFromSearchFieldsCount
		///This method returns the collection count of BOLines objects, filtered by a search object
		///</Summary>
		///<returns>
		///Int32
		///</returns>
		...
		///
		///</parameters>
		public static Int32 LinesCollectionFromSearchFieldsCount(BOLines boLines)
		{
			try
			{
				DAOLines daoLines = new DAOLines();
				...
				daoLines.Name = boLines.Name;
				daoLines.Number = boLines.Number;
				Int32 objCount = DAOLines.SelectAllBySearchFieldsCount(daoLines);
				return objCount;
			}
			catch
			{
		...
		public virtual void LoadContainersCollection()
		{
			try
			{
				...
				IList<DAOContainers> daoContainersCollection = DAOContainers.SelectAllByLineid(_id.Value);
		...
		public virtual void AddContainers(BOContainers boContainers)
		{
			...
			try
			{
				...
				daoContainers.Lineid = _id.Value;
		...
		public virtual void DeleteAllContainers()
		{
			...
			try
			{
				DAOContainers.DeleteAllByLineid(ConnectionProvider, _id.Value);
				CommitTransaction();
				if(_boContainersCollection != null)
				{
		...
		public virtual void LoadTrailCollection()
		{
			try
			{
				...
				IList<DAOTrail> daoTrailCollection = DAOTrail.SelectAllByLineid(_id.Value);
		...
		public virtual void DeleteAllTrail()
		{
			...
			try
			{
				DAOTrail.DeleteAllByLineid(ConnectionProvider, _id.Value);
				CommitTransaction();
				if(_boTrailCollection != null)
				{
